<div class="page-actions">
    <a href="<?= BASE_URL ?>/flight-services/import" class="btn btn-light">
...
<div class="card mb-3">
    <div class="card-body py-3">
        ...
        <div class="d-flex gap-3 flex-wrap text-muted" style="font-size:14px;">
            ...
            <span class="cumple-si"><i class="bi bi-check-circle-fill"></i> <?= (int)$import['filas_exitosas'] ?> exitosas</span>
