...
<form method="POST" action="<?= BASE_URL ?>/flight-services/edit/<?= $service['id'] ?>" novalidate id="flightServiceForm" data-service-id="<?= $service['id'] ?>">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            <div class="col-md-3"><label for="air_starter" class="form-label">Arranque de Motores "Air Starter"</label>
                <input type="number" class="form-control" id="air_starter" name="air_starter" value="<?= (int)($service['air_starter'] ?? 0) ?>" min="0"></div>
            <div class="col-md-3"><label for="pay_mower" class="form-label">Pay Mower</label>
                <input type="number" class="form-control" id="pay_mower" name="pay_mower" value="<?= (int)($service['pay_mower'] ?? 0) ?>" min="0"></div>
            <div class="col-md-3"><label for="aseo_aeronaves" class="form-label">Aseo a las Aeronaves</label>
                <input type="number" class="form-control" id="aseo_aeronaves" name="aseo_aeronaves" value="<?= (int)($service['aseo_aeronaves'] ?? 0) ?>" min="0"></div>
            <div class="col-md-3"><label for="equipos_carga_descargue" class="form-label">Equipos para Carga y Descargue de Mercancías</label>
                <input type="number" class="form-control" id="equipos_carga_descargue" name="equipos_carga_descargue" value="<?= (int)($service['equipos_carga_descargue'] ?? 0) ?>" min="0"></div>
            <div class="col-md-3"><label for="atencion_pasajeros" class="form-label">Atención a Pasajeros</label>
                <input type="number" class="form-control" id="atencion_pasajeros" name="atencion_pasajeros" value="<?= (int)($service['atencion_pasajeros'] ?? 0) ?>" min="0"></div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calcularCumplimiento() {
        ...
        // Demora solo si salió tarde Y el tránsito excede el estipulado
    ...
    ['hora_itinerada_llegada', 'hora_real_llegada', 'hora_real_salida', 'hora_itinerada_salida', 'tiempo_cumplimiento_custom'].forEach(function(id) {
        const el = document.getElementById(id);
